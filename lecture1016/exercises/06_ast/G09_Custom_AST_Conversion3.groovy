...
public class NumberConversionTransformation1 implements ASTTransformation {
    ...
    public void visit(ASTNode[] astNodes, SourceUnit source) {
        ...
        List<ASTNode> exprstmt = ab.buildFromString('''
                a + b
            ''')
        def param1 = new Parameter(ClassHelper.Integer_TYPE, "a")
        def param2 = new Parameter(ClassHelper.Integer_TYPE, "b")
        annotatedClass.addMethod("add", Opcodes.ACC_PUBLIC, ClassHelper.Integer_TYPE, [param1, param2] as Parameter[], [] as ClassNode[], exprstmt[0])
    }
}
