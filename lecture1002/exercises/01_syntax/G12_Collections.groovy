...
assert 26 == [1, 2, 3, 4, 3, 4, 19, 26, 25, 19, 22, 25, 3, 10, 12, 23, 24, 12, 11, 18].inject(0){acc, v -> (acc < v) ? v : acc}
//acc is accumulate and the value in the brackets is the initial one
